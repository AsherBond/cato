...
function GetItems() {
	args = {};
	args.sStatus = getQuerystringVariable("status");
	args.sSearch = $("#txtSearch").val();
	args.sFrom = $("#txtStartDate").val();
	args.sTo = $("#txtStopDate").val();
	args.sRecords = $("#txtResultCount").val();

	var response = catoAjax.task.getTaskInstances(args);
	if (response) {
