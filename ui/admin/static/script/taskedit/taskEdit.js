...
$(document).ready(function() {
    ...
    doGetCodeblocks();
    //get the steps
    // if a 'codeblock' argument was passed on the querystring, switch context to that codeblock
    var goto_cb = getQuerystringVariable("codeblock");
    if (goto_cb) {
        $("#hidCodeblockName").val(goto_cb);
    }
    doGetSteps();
});
