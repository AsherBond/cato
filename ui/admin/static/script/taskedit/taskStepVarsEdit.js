...
$(document).ready(function() {
	...
	$("#new_delimited_position").keypress(function(e) {
		return restrictEntryToInteger(e, this);
	});
...
function checkForNameConflicts() {
	...
	$("#edit_variables .var_name").each(function(intIndex) {
		var $me = $(this);
...
function addParsedVar() {
	...
	foo += "<span class=\"variable_name\">";
	foo += "Variable: <input type=\"text\" value=\"" + varname + "\" id=\"v" + vid + "_name\"" + "  class=\"code var_name var_unique\" />";
	foo += "</span>";
