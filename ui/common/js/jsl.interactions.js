...
/*
 * NSC: 1-14 - Modified to inject output directly to pages in CSK Cato.
 *
 * */
...
jsl.interactions = ( function() {
        ...
        function validate($json_input, $results_div, reformat, compress) {
            var lineNum, lineMatches, lineStart, lineEnd;
        ...
        function validate_string(reformat, compress) {
            var lineNum, lineMatches, lineStart, lineEnd, result;
